...
// função findInArray (array, value)
...
// Remove o ultimo elemento  array.pop()
console.log("Elemento removido",users.pop());
console.log(users);

// Remove o primeiro elemento array.shift()
users.shift();
console.log(users);
...
// Concatena os itens do vetor separados pelo caracter indicado
